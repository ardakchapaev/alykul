        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href={`/${lang}/partners`} className="block font-m4-body text-white/40 text-[13px] font-light hover:text-white/70 transition-colors">{lang === 'ru' ? 'Партнёрам' : lang === 'ky' ? 'Өнөктөштөргө' : 'Partners'}</a>
              <a href={`/${lang}/careers`} className="block font-m4-body text-white/40 text-[13px] font-light hover:text-white/70 transition-colors">{lang === 'ru' ? 'Карьера' : lang === 'ky' ? 'Карьера' : 'Careers'}</a>
            </div>
          </div>
