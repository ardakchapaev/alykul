...
export default function ScrollToTop() {
  ...
  return (
    <button onClick={scrollUp}
      className="fixed bottom-36 md:bottom-20 right-6 z-[10002] w-11 h-11 rounded-full bg-navy/80 backdrop-blur text-white shadow-lg hover:bg-navy transition-all flex items-center justify-center"
