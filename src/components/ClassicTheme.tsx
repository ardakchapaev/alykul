      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-10">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-3 mt-3 items-center">
            {/* WhatsApp */}
            <a href="https://wa.me/996555123456" title="WhatsApp" aria-label="WhatsApp" className="text-[#25D366] hover:opacity-70 transition-opacity">
            ...
            {/* Telegram */}
            <a href="https://t.me/alykul_bot" title="Telegram" aria-label="Telegram" className="text-[#26A5E4] hover:opacity-70 transition-opacity">
            ...
            {/* Instagram */}
            <a href="#" title="Instagram" aria-label="Instagram" className="text-[#E1306C] hover:opacity-70 transition-opacity">
